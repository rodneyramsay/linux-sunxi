...
#if defined CONFIG_SUNXI_G2D || defined CONFIG_SUNXI_G2D_MODULE
...
#if IS_ENABLED(CONFIG_VIDEO_DECODER_SUNXI) || \
	IS_ENABLED(CONFIG_VIDEO_DECODER_SUN5I)
/* The VE block is used by:
 *
 * - the Cedar video engine, drivers/media/video/sun[457]i
 */
...
#if defined RESERVE_VE_MEM || defined CONFIG_SUNXI_G2D || \
	defined CONFIG_SUNXI_G2D_MODULE || defined CONFIG_FB_SUNXI_RESERVED_MEM
