...
static struct resource sw_uart_res[8][2] = {
	RES(UARTx_BASE(0), AW_IRQ_UART0),
	RES(UARTx_BASE(1), AW_IRQ_UART1),
	RES(UARTx_BASE(2), AW_IRQ_UART2),
	RES(UARTx_BASE(3), AW_IRQ_UART3),
	RES(UARTx_BASE(4), AW_IRQ_UART4),
	RES(UARTx_BASE(5), AW_IRQ_UART5),
	RES(UARTx_BASE(6), AW_IRQ_UART6),
	RES(UARTx_BASE(7), AW_IRQ_UART7),
};
#undef RES
